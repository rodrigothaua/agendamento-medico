...
<div id="toast-container" class="fixed {{ $positionClass }} z-50 space-y-2">
...
class ToastManager {
    ...
    createToast(id, message, type) {
        ...
        toast.id = id;
        toast.className = `transform translate-x-full opacity-0 transition-all duration-300 ease-in-out max-w-sm w-full bg-white shadow-lg rounded-lg pointer-events-auto ring-1 ring-black ring-opacity-5 overflow-hidden`;
